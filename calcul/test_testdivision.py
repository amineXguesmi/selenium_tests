...
class TestTestdivision():
  ...
  def test_testdivision(self):
    ...
    self.driver.find_element(By.ID, "num2").send_keys("20")
    self.driver.find_element(By.CSS_SELECTOR, "button").click()
    assert self.driver.find_element(By.ID, "result").text == "Résultat : 0.75"
    self.driver.find_element(By.CSS_SELECTOR, "html").click()
    self.driver.find_element(By.ID, "num1").send_keys("20")
    self.driver.find_element(By.CSS_SELECTOR, "button").click()
    assert self.driver.find_element(By.ID, "result").text == "Résultat : 1"
