...
class TestTestsoustraction():
  ...
  def test_testsoustraction(self):
    ...
    self.driver.find_element(By.ID, "num2").send_keys("15")
    self.driver.find_element(By.CSS_SELECTOR, "button").click()
    self.driver.find_element(By.CSS_SELECTOR, "button").click()
    self.driver.find_element(By.ID, "calculatorForm").click()
    self.driver.find_element(By.CSS_SELECTOR, "button").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, "button").click()
    assert self.driver.find_element(By.ID, "result").text == "Résultat : 10"
