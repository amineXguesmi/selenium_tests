...
class TestTestmultiplication():
  ...
  def test_testmultiplication(self):
    ...
    element = self.driver.find_element(By.ID, "operator")
    ...
    self.driver.find_element(By.CSS_SELECTOR, "button").click()
    assert self.driver.find_element(By.ID, "result").text == "Résultat : -144"
